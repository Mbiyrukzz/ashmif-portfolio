...
const Contact = () => {
  return (
    <form className="rounded-lg shadow-xl flex flex-col px-8 py-8 bg-white border-[#6c63ff] border-2">
      ...
      <label title="email" className=" font-bold mt-4 text-gray-900">
      ...
      <label className=" font-bold mt-4 text-gray-900">
      ...
      <div className="flex flex-row items-center justify-start">
        <button className="px-10 mt-8 py-2 bg-[#130F49] text-gray-50 font-bold rounded-md text-lg flex flex-row items-center">
          Send
          <svg
            width="24"
            height="24"
